...
KERNEL_DIR=`pwd`
TC_BRANCH="clang-r510928"                 #https://github.com/Neutron-Toolchains/clang-build-catalogue
TC_DIR="$HOME/tc/clang/$TC_BRANCH"
TC_URL="https://gitlab.com/lecmngend/clang"
...
export THINLTO_CACHE=$THINLTO_CACHE_DIR #Use host thinlto_cache_dir (you should have this in bashrc file)

# Setup MAKE variable
SECONDS=0 # builtin bash timer
export PROC=-j12
export PATH="$TC_DIR/bin:$PATH" # To use other host toolchain 
